...
const Carbon_Book = () => {
  ...
  const handleSaveBtn = () => {
    if (
      ...
      !generatedRenewal ||
      !reductionByRenewal ||
      (showOtherInitatives && !otherkwhReduction) ||
      (showOtherInitatives && !otherCountryOfReduction) ||
      !startDate ||
      !endDate
    ) {
    ...
    !loading &&
      updateOrCreateCarbonBook(user?.uid, {
  ...
  useEffect(() => {
    // other initative measure calculation
    const currentFactor = 0.4;
    ...
    <div>
      ...
      <div className="carbon__book">
        ...
        <div className="carbon__input">
          ...
          <Dropdown
            options={["UAE"]}
            setValue={setRenewalCountry}
            currValue={renewalCountry}
          />

          <p>Type of Renewal</p>
          <Dropdown
            options={["Solar"]}
            setValue={setRenewalType}
            currValue={renewalType}
          />

          <p>Generated Renewal</p>
          <BusinessInput
            setValue={setGeneratedRenewal}
            currValue={generatedRenewal}
            type={"number"}
          />
          ...
          {!showOtherInitatives && (
            <div className="flexrow">
              <div
                onClick={() => setShowOtherInitatives(true)}
                className="addButton"
              >
          ...
          {showOtherInitatives && (
            <div className="carbon__input">
              ...
              <BusinessInput
                setValue={setotherkwhReduction}
                currValue={otherkwhReduction}
                type={"number"}
              />

              <p>Country of Reduction </p>
              <BusinessInput
                setValue={setOtherCountryOfReduction}
                currValue={otherCountryOfReduction}
                type={"text"}
              />
          ...
          <BusinessInput
            setValue={setco2Externally}
            currValue={totalco2Externally}
            type={"number"}
          />
        </div>
