  ...
  return (
    <div>
      ...
      <div className="profile__data">
        ...
        <ProfileComponent left="Contact no." right={profileData?.contactNumber} />
        <ProfileComponent left="Email" right={profileData?.email}/>
        <ProfileComponent left="Profession" right={profileData?.profession} />
        <ProfileComponent left="Address" right={profileData?.address1+', '+profileData?.address2} />
        <ProfileComponent left="I typically buy" right={profileData?.typicallyBuy} />
        <ProfileComponent left="Actively looking to buy" right={profileData?.lookingToBuy} />
