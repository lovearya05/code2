      ...
      <div className='mainView' >
        <div className='topContent' >
          ...
          <div className='row' >
            ...
            <p className='topText-s greenTest'>2</p>
          </div>
        </div>
        ...
        <div className="userInputs_s">
          <div className='inputHeading' >
            ...
            <div className='input_div' >
              <input onChange={(e)=> setEmail(e.target.value) } placeholder='abc@gmail.com' className='input' />
            </div>
          </div>
          ...
          <div className='inputHeading' >
            ...
            <div className='input_div' >
              <input onChange={(e)=>setPassword(e.target.value) } placeholder='enter password' type='password' className='input' />
            </div>
          </div>
